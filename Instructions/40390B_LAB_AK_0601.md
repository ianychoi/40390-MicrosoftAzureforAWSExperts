...
10. On the **Custom deployment** blade, in the **Virtual Machines_VM1_admin Password** text box, type **DemoPa$$w0rd**

11. In the **Resource group** section, click **Use existing**, and, in the drop down list, click **ARMTemplatesVMRG**
...
17. Wait for the deployment of the VM to complete. You can monitor it by viewing the **Last deployment** status. This should be changing from **(Deploying)** to **(Succeeded)**
