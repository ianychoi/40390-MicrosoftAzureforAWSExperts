...
- BLOB copy between storage accounts.
...
1. In the portal create a second storage account. Give the name of the storage account armtrainingstore2<your-name>, where the suffix is your name.

2. Select the newly created storage account. Right click on **Blob Containers**, and then select **Create Blob Container**, and name it **newcontainer2**.

3. Open the **Microsoft Azure Storage Explorer** and browse to the file your uploaded earlier. Right-click and select **Copy**, and browse to **newcontainer2**, and select **Paste**.

4. Click **Refresh** to view the file copied to this container.
